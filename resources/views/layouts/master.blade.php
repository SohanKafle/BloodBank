    ...
    <header class="bg-white">
        <nav class="bg-red-600 shadow-md fixed top-0 left-0 w-full z-50">
            <div class=" flex justify-between items-center py-0 pr-0 md:px-0 mr-4">
                ...
                <a href="/"> <img src="{{asset('images\donor\logoo.png')}}" alt="Bloodbank Logo" class="h-10 mr-20"></a>
                ...
                <ul id="nav-links" class="hidden md:flex gap-10 items-center">
                    <li>
                        <a href="/" class="text-xl font-medium flex items-center space-x-1 text-white hover:text-black">
                            <i class='bx bx-home'></i>
                            <span>Home</span>
                        </a>
                    </li>
                    <li>
                        <a href="/about" class="text-xl font-medium flex items-center space-x-1 text-white hover:text-black">
                    ...
                    <li>
                        <a href="/contact" class="text-xl font-medium flex items-center space-x-1 text-white hover:text-black">
                ...
                <div class="hidden md:flex items-center space-x-4 lg:order-2">
                    <a href="{{ route('login') }}">
                        <button type="button" class="px-4 lg:px-5 py-1 my-1 mr-2 text-white bg-gradient-to-br from-purple-500 to-purple-400 hover:bg-gradient-to-bl font-medium rounded-lg text-lg">
                            Login
                        </button>
                    </a>
                    <a href="{{ route('register') }}">
                        <button class="relative px-5 inline-flex items-center justify-center py-1 overflow-hidden text-lg font-medium text-gray-900  rounded-lg group bg-gradient-to-br from-red-200 via-red-300 to-yellow-200 group-hover:from-red-200 group-hover:via-red-300 group-hover:to-yellow-200 ">
                           Register
                        </button>
                    </a>
                </div>
