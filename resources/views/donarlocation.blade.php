...
<div class="form-row" id="address">
  ...
  <div class="form-group col-md-4">
     ...
     <input type="text"  class="field form-control" id="route" name="route" disabled="true" placeholder="123 Main Street" value="{{ old('street', $hospitalProfile->street) }}">       
  </div>
  <div class="form-group col-md-6">
      <label class="label text-sm">City</label>
      <input type="text" class="field form-control" id="locality" disabled="true" name="locality" placeholder="City" value="{{ old('city', $hospitalProfile->city) }}">
  </div>    
  <div class="form-group col-md-6 col-sm-12">
      <label class="label text-sm">Province</label>
      <input type="text" class="field form-control" id="administrative_area_level_1" disabled="true" name="administrative_area_level_1" placeholder="Province" value="{{ old('province', $hospitalProfile->province) }}">
  </div>
  <div class="form-group col-md-6">
      <label class="label text-sm">Zip code</label>
      <input type="text" class="field form-control" id="postal_code" disabled="true" name="postal_code" placeholder="Zip" value="{{ old('zip', $hospitalProfile->zip) }}">
  </div>
</div>
...
//Variables for displaying the address on the map
	...
	var lat = '{{$UserProfile->address_latitude}}';
	var lng = '{{ $UserPofile->address_longitude}}';
</script>
