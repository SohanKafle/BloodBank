...
<section class="relative bg-pink-200 text-center py-20" data-aos="fade-up">
    ...
    <div class="relative container mx-auto px-4 py-16">
        <div class="flex flex-col items-center text-center">
            ...
            <div class="text-2xl font-bold text-white mt-5 mb-8 bg-red-500 py-3 px-2 rounded-lg">Donate Today</div>
            <br>
            <br>
            <p class="text-lg mb-0 mt-12 font-medium">Every blood donation counts, and every donor is a hero. <br>Be a hero today and donate blood.</p>
        ...
        <section id="search" class="container mx-auto px-4 py-8 bg-pink-100" data-aos="fade-down">
            <div class="flex flex-col lg:flex-row items-center lg:items-start ml-6">
                ...
                <div class="flex-1 flex justify-center lg:justify-end pr-10">
                    <img class="rounded-lg shadow-md" src="https://t4.ftcdn.net/jpg/02/21/47/99/360_F_221479946_2yUmWRmVPBka6d4zcXbBhJbRra8WcpQV.jpg" alt="Blood Donation" />
                </div>
            </div>
        </section>
